...
import threading
import time
from virtual_assistant_temp import voice_assist
...
class Facial_Recognition_System:
    def __init__(self, root):       #root -  window name     
        ...
        player = tkvideo("tech_bg_vid.mp4", bg_vid, loop=1, size=(1300, 700))
        player.play()
        ...
        img2=Image.open(r"C:\Face_recog_system - Copy\student_button.jpg")
        ...
        img3=Image.open(r"C:\Face_recog_system - Copy\face_id_button.jpg")
        ...
        img5=Image.open(r"C:\Face_recog_system - Copy\exit.jpg")
        ...
        img6=Image.open(r"C:\Face_recog_system - Copy\help_desk.jpg")
    ...
    def open_virtual_assistant(self):
        time.sleep(3)
        self.assistant_window = Toplevel(self.root)
        self.app = voice_assist(self.assistant_window)
        self.assistant_opened = False
